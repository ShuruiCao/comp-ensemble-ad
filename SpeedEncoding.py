...
def normalize_sequence(sequence, normalization_params):
    mean_values = normalization_params['mean']
    std_values = normalization_params['std']
    # Apply normalization
...
anomalous = pd.read_pickle(os.path.join(data_directory, 'routespeed_anomalous.pkl'))
anomalous = filter_trips(anomalous, 3, 150000)
# data_directory = '/data/shurui/{}Synthetic/Processed'.format(dataset)

# # backforth03 = pd.read_pickle(os.path.join(data_directory, 'routespeed_backforth03.pickle'))
# # stop03 = pd.read_pickle(os.path.join(data_directory, 'routespeed_stop03.pickle'))
# # detour03 = pd.read_pickle(os.path.join(data_directory, 'routespeed_detour03.pickle'))
# # speed2 = pd.read_pickle(os.path.join(data_directory, 'routespeed_speed2.pickle'))
# # test = pd.read_pickle('/data/shurui/{}/processed/routespeed_test.pkl'.format(dataset))
# stitch = pd.read_pickle(os.path.join(data_directory, 'routespeed_stitch.pickle'))
# rotation = pd.read_pickle(os.path.join(data_directory, 'routespeed_rotation.pickle'))
# repeat05 = pd.read_pickle(os.path.join(data_directory, 'routespeed_repeat05.pickle'))
# repeat1 = pd.read_pickle(os.path.join(data_directory, 'routespeed_repeat1.pickle'))
# loop = pd.read_pickle(os.path.join(data_directory, 'routespeed_loop.pickle'))
...
model_configurations = [
    # {
    #     'name': 'speed',
    #     'save_path': os.path.join(basepath, 'Model/{}/speed_512'.format(dataset)),
    #     'input_size': 1,
    #     'hidden_size': 512,
    ...
    # {
    #     'name': 'speed',
    #     'save_path': os.path.join(basepath, 'Model/{}/speed_128'.format(dataset)),
    #     'input_size': 1,
    #     'hidden_size': 128,
    #     'checkpoint': 'model_epoch_100.pth'
    # },
    {
        'name': 'speed',
        'save_path': os.path.join(basepath,  'Model/{}/speed_64'.format(dataset)),
        'input_size': 1,
        'hidden_size': 64,
        'checkpoint': 'model_epoch_100.pth'
    },
    {
        'name': 'speed',
        'save_path': os.path.join(basepath,  'Model/{}/speed_16'.format(dataset)),
        'input_size': 1,
        'hidden_size': 16,
        'checkpoint': 'model_epoch_100.pth'
    },
